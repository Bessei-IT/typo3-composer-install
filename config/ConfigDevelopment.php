...
// https://github.com/helhum/TYPO3-Distribution/blob/4cac7b6d0e3519a87b7592d24c5200461b9d7ac6/conf/development.php
return [
    'SYS'  => [
        // Debug
        'displayErrors'        => 1,
    ...
    'MAIL' => [
        'transport'           => 'mbox',
        'transport_mbox_file' => dirname(PATH_site) . '/log/sent-mails.log',
    ],
    'LOG'  => [
        'writerConfiguration' => [
            \TYPO3\CMS\Core\Log\LogLevel::DEBUG => [
                \TYPO3\CMS\Core\Log\Writer\FileWriter::class => [
                    dirname(PATH_site) . '/log/typo3-debug.log',
                ],
            ],
        ],
    ],
